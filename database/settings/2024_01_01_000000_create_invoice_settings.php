...
return new class extends SettingsMigration
{
    public function up(): void
    {
        ...
        $this->migrator->add('invoices.default_currency', 'KES');
        ...
        $this->migrator->add('invoices.invoice_prefix', 'INV-');
        $this->migrator->add('invoices.paper_size', 'a4');
        $this->migrator->add('invoices.include_terms', true);
        $this->migrator->add('invoices.terms_text', 'Payment is due within the specified payment terms. Late payments may incur additional charges.');
    }
};
