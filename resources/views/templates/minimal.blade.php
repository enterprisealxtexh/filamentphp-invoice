...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: 'DejaVu Sans', Arial, sans-serif; font-size: 12px; line-height: 1.6; color: #1a1a1a; background: #fff; }
        .invoice-container { max-width: 800px; margin: 0 auto; padding: 60px 50px; }
        .header { margin-bottom: 60px; }
        .invoice-title { font-size: 11px; text-transform: uppercase; letter-spacing: 3px; color: #999; margin-bottom: 5px; }
        .invoice-number { font-size: 28px; font-weight: 300; color: #1a1a1a; }
        .meta-section { display: table; width: 100%; margin-bottom: 50px; }
        ...
        .meta-value { font-size: 13px; color: #1a1a1a; }
        .meta-value strong { font-weight: 600; }
        .company-info { font-size: 11px; color: #666; line-height: 1.8; }
        .status-badge { display: inline-block; padding: 4px 12px; font-size: 10px; text-transform: uppercase; letter-spacing: 1px; border: 1px solid #1a1a1a; }
        .status-paid { border-color: #22c55e; color: #22c55e; }
        .status-sent { border-color: #3b82f6; color: #3b82f6; }
        .status-overdue { border-color: #ef4444; color: #ef4444; }
        .status-draft { border-color: #9ca3af; color: #9ca3af; }
        .status-cancelled { border-color: #f59e0b; color: #f59e0b; }
        .items-table { width: 100%; border-collapse: collapse; margin-bottom: 40px; }
        .items-table th { border-top: 1px solid #1a1a1a; border-bottom: 1px solid #1a1a1a; padding: 15px 0; text-align: left; font-size: 10px; text-transform: uppercase; letter-spacing: 1px; font-weight: 600; }
        .items-table td { padding: 20px 0; border-bottom: 1px solid #eee; vertical-align: top; }
        .text-right { text-align: right; }
        .text-center { text-align: center; }
        .item-name { font-weight: 500; }
        .item-description { font-size: 11px; color: #666; margin-top: 4px; }
        .summary-section { display: table; width: 100%; margin-bottom: 40px; }
        ...
        .totals-label { display: table-cell; font-size: 11px; color: #666; }
        .totals-value { display: table-cell; text-align: right; font-weight: 500; }
        .grand-total { border-top: 1px solid #1a1a1a; margin-top: 15px; padding-top: 15px; }
        .grand-total .totals-label, .grand-total .totals-value { font-size: 14px; font-weight: 600; color: #1a1a1a; }
        .notes-section { padding: 20px 0; border-top: 1px solid #eee; }
        .notes-label { font-size: 10px; text-transform: uppercase; letter-spacing: 2px; color: #999; margin-bottom: 10px; }
        .notes-text { font-size: 12px; color: #666; }
        .footer { margin-top: 60px; text-align: center; font-size: 10px; color: #999; letter-spacing: 1px; }
    </style>
</head>
<body>
